...
def plt_eff_high(MG_eff_highETX, eff_highETX,tauN,  mass_Zp , mass_s):
    ...
    plt.savefig(f"./Plots_High/Efficiency_comparison_mH{mass_Zp}_mS{mass_s}.png")
    plt.close()
...
def plt_eff_low(MG_eff_lowETX, eff_lowETX,tauN,  mass_Zp , mass_s):
    ...
    plt.savefig(f"./Plots_Low/Efficiency_comparison_mH{mass_Zp}_mS{mass_s}.png")
    plt.close()
...
def plt_cross_High(eff_highETX, tauN, mass_Zp, mass_s, factor):
    ...
    plt.savefig(f"./Plots_High/Cross_section_mH{mass_Zp}_mS{mass_s}.png") #create a new fodlder ' Plots ' and save the fig in it
    plt.close()
...
def plt_cross_Low(eff_lowETX , tauN, mass_Zp, mass_s, factor):
    ...
    plt.legend( fontsize = 10, loc=3)
    plt.savefig(f"./Plots_Low/Cross_section_mH{mass_Zp}_mS{mass_s}.png") #create a new fodlder ' Plots ' and save the fig in it
    plt.close()
