...
for file_selection, MG_file_selection,mass_Zp,mass_s, nevent, factor in zip(File_selection, MG_File_selection, Mass_Zp,Mass_s, Nevent, Factor):
    ...
    P8_px_DH, P8_py_DH, P8_pz_DH, P8_E_DH, P8_mass_DH, P8_pdg_DH = cmfps.conversion_one_list_DH(px_TOT_DH, py_TOT_DH, pz_TOT_DH, E_TOT_DH, mass_TOT_DH, pdg_TOT_DH)
...
###########################################################Computing the efficiencies and ploting the results###########################################################
    ...
    if mass_Zp >= 400: # Condition if the sample is 'High-ET' or ' Low-ET'
        ...
        eff_highETX = cmfpa.eff_map_High(pT_DH, eta_DH, Lxy_tot_DH, Lz_tot_DH, abs(pdg_tot_DH), pT_Zp, eta_Zp, Lxy_tot_Zp, Lz_tot_Zp, abs(pdg_tot_Zp), tauN, nevent, mass_Zp, mass_s) # Compute the efficiency from Pythia
        ...
        MG_eff_lowETX = cmfpa.eff_map_MG_low(MG_pT_DH, MG_eta_DH,MG_Lxy_tot_DH, MG_Lz_tot_DH, abs(MG_pdg_DH), MG_pT_Zp, MG_eta_Zp, MG_Lxy_tot_Zp, MG_Lz_tot_Zp, abs(MG_pdg_Zp), tauN, nevent, mass_Zp, mass_s)
        eff_lowETX = cmfpa.eff_map_Low(pT_DH, eta_DH, Lxy_tot_DH, Lz_tot_DH, abs(pdg_tot_DH), pT_Zp, eta_Zp, Lxy_tot_Zp, Lz_tot_Zp, abs(pdg_tot_Zp), tauN,nevent, mass_Zp, mass_s)
