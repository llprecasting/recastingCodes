...
Nevent = [10000,10000,10000,50000,50000] # Nbr of events. If you want to change the number of event, you also need to change the values in the function : "Writing_Scripts_MG+P8.py" which generates the events.
...
###########################################################Computing the efficiencies and ploting the results###########################################################
    ...
    if mass_phi >= 400: # Condition if the sample is 'High-ET' or ' Low-ET'
        ...
        cmfp.plt_eff_high(MG_eff_highETX, eff_highETX, tauN, data_HEP, mass_phi, mass_s ) # Ploting and saving a comparison of all the results of efficiencies, in the folder 'Plots_High'.
        cmfp.plt_cross_High(eff_highETX, tauN, mass_phi, mass_s, branch_HEP_limit, factor) # Ploting and saving a comparison of the limits obtained with the map and by ATLAS, in the folder 'Plots_High'.
        ...
        cmfp.plt_eff_low(MG_eff_lowETX, eff_lowETX, tauN, data_HEP, mass_phi, mass_s ) # Ploting and saving a comparison of all the results of efficiencies, in the folder 'Plots_Low'.
        cmfp.plt_cross_low(eff_lowETX, tauN, mass_phi, mass_s, branch_HEP_limit, factor) # Ploting and saving a comparison of the limits obtained with the map and by ATLAS, in the folder 'Plots_Low'.
    count+=1
