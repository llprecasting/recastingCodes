...
int main() {
 ...
 //         "8.99376000e+03",   "1.49896000e+04"};
  ...
  string ctauValues[8] = {"2.99792000e+00",   "2.99792000e+00", "1.19916800e+01",   "2.99792000e+01",
         "2.99792000e+02",   "8.99376000e+02", "2.99792000e+03","7.35629610e+03"};
  ...
  //Files
  ofstream effCutFlow;
  effCutFlow.open("Plots/truthDV_data/effCutFlow_2000_compressed.dat"); 
  ofstream effVsTau;
  effVsTau.open("Plots/truthDV_data/effVsTau_2000_compressed.dat"); 
  cout<<"###################"<<endl;
  pythia.readString("1000021:m0=2000"); // gluino mass
  pythia.readString("1000022:m0=1900"); // neutralino mass
